...
To build the final jar and optimize the jhipsterAppl application for production, run:
...
[service discovery and configuration with consul]: https://www.jhipster.tech/documentation-archive/v6.4.1/microservices-architecture/#consul
