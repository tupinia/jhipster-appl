...
import com.mycompany.myapp.JhipsterApplApp;
import com.mycompany.myapp.config.SecurityBeanOverrideConfiguration;
import com.mycompany.myapp.service.JhipsterApplKafkaProducer;
import com.mycompany.myapp.service.JhipsterApplKafkaConsumer;
...
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, JhipsterApplApp.class})
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class JhipsterApplKafkaResourceIT {
    ...
    @Autowired
    private JhipsterApplKafkaProducer producer;

    @Autowired
    private JhipsterApplKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JhipsterApplKafkaResource kafkaResource = new JhipsterApplKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jhipster-appl-kafka/publish?message=test"))
